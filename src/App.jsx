        ...
        return(
            <>
                ...
                <div className='films-wrapper'>
                    <MovieList data = {data} setAboutMovieData = {setAboutMovieData} setIsForm = {setIsForm} setAddElement = {setAddElement} addElement ={addElement}></MovieList>
                    <AboutMovie data={aboutMovieData} isForm ={isForm} setIsForm ={setIsForm} setFormData ={setFormData} setEditId ={setEditId}></AboutMovie>;
                </div>
